...
export default function TasksPage({
  ...
  onTaskDeleted: (id: string, deletedTask: Task) => void
  ...
  const toggleTask = async (id: string) => {
    ...
    try {
      ...
      if(updatedTask.completed) {
        onShowToast({ message: 'Task Complete!', type: 'success'})
      } else {
        onShowToast({ message: 'Task complete undone', type: 'success'})
      }
      ...
      onShowToast({ message: `Failed to toggle task: ${error}`, type: 'error' })
    }
  }
  ...
  const deleteTask = async (id: string) => {
    ...
    try {
      ...
      onTaskDeleted(id, deletedTask)
    } catch(error) {
      onShowToast({ message: `Failed to delete task: ${error}`, type: 'error' })
    }
  }
  return (
